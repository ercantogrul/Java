...
public class SatIslemler implements InterIslem{
    ...
    public void veriUpdate(){
        ...
        try {
            int id=scan.nextInt();  // buradan hangi ID istiyorsak girariz örn: 7
            Satislar kayit = Runner.satList.get(id); // burada ise o kaydin yani (bu id li) veriyi kayit icine atiyor
            //System.out.println("____________"+kayit); //____________     7         2     18-01-2024               satis         230         210
