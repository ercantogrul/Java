...
public class IslemKisiler {
    public static void veriAdd(){
        ...
        System.out.print("Telefon numarasini giriniz (alan kodu ve sifir olmadan) : ");
        ...
        FileKisiler fKisiler = new FileKisiler();
        fKisiler.dosyayaYaz();
    ...
    public static void veriList(){
        ...
        System.out.println("==========MEVCUT MÜSTERI LISTESI========== ");
        String baslik = String.format("%5s","  ID ");
        baslik  = baslik + String.format("%20s","Ad Soyad");
