package asya_hoca_.Projects.Film_Ratespiel;
...
public class User {
    ...
    public static void userMenu() {
        System.out.println("Hesabiniz var mi? Evet yada Hayir seklinde cevaplayiniz :");
        ...
        if (cevap.equals("e")) {
            ...
            if (nameIdex == parolaIdex) {
                ...
                for (int i = 0; i <secilenFilm.length()*2 ; i++) {
                    ...
                    if (filmTahmini.equalsIgnoreCase((secilenFilm))){
                        System.out.println("Tebrikler "+(i+1)+". denemede dogru tahmin ettiniz");break;
                    }else {
                        System.out.println((secilenFilm.length()*2)-(i+1) +" hakkiniz kalmistir. Tekrar deneyiniz");
                    }
                }
            }
        } else {
    ...
    public static void kayitMenu() {
        ...
        String userParola = scan.next().toUpperCase();
