package asya_hoca_.Projects.Tas_Kagit_Makas;
...
public class tas_kagit_makas {
     ...
     */
        ...
        do {
            ...
            try {
                user = scan.nextInt(); // kullanicidan secimi aldik
                if (user < 1 || user > 3) {
                    System.out.println("Yanlis secim yaptiniz 1 ile 3 arasinda rakam girmelisiniz");
                }
                if (user == 4) {
                    System.out.println("Cikis yaptiniz");
                    System.exit(0);
                } else if (user>0 &&user<4){
                    System.out.println("Oyuncunun secimi    :"+isim(user));
                }
            } catch (Exception e) {
                System.out.println("Yanlis secim yaptiniz 1 ile 3 arasinda rakam girmelisiniz");
                user = scan.nextInt();
