package day24_Encapsulation.DE24_Encapsulation_ilk;
...
public class C01_Encapsulation {
 ...
 public static void main(String[] args) {
  ...
  //   System.out.println(tur);
     ...
     can.setTur("Imnsan");
     System.out.println(can.getTur());  //Insan
     Canli2 can2 = new Canli2("Havan",2101);
     // ustteki işlemde can2 adında bir objeyi Canli2 classından  oluşturduk,
     // sonra can2.tur="Hayvan", sonra can2.dYili=2101;  //// doğrudan veri atama
     // veya can2.setTur("Hayvan")+can2.setdYili(2101)  //// kapsülleyerek veri atama
