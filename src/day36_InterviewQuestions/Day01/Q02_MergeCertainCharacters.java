...
public class Q02_MergeCertainCharacters {
    ...
    public static void main(String[] args) {
        ...
        String strilkvesonHarfler = (str.trim().substring(0,1))+(str.substring(str.length()-1));
        System.out.println(strilkvesonHarfler);
        System.out.println("strilkvesonHarfler.repeat(sayi) = " + strilkvesonHarfler.repeat(sayi));
