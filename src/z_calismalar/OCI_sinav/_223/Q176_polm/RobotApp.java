package z_calismalar.OCI_sinav._223.Q176_polm;
...
public class RobotApp {
	...
	public static void main(String[] args) {
		...
		r.process();
		r.speak("Done");
		// Speakable x = new Robot(); // abstract claslardan obje üretilemez yani constructor abstrac veya interface den verilemez
