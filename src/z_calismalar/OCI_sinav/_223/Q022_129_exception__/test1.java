...
public class test1 {
    public static void main(String[] args) {
        ...
        try {
            ...
            ans=4; //ans variablesine burada da 4 degeri atanmis yani her iki ihtimaldede int e deger verilmis dolayisiyla sout da bu iki ihtimalden biri cikacagi icin yazdirabilir cte vermez
