package z_calismalar.OCI_sinav._223.Q016_LocalDate;
...
//****LocalDate verip format(DateTimeFormatter.ISO_DATE_TIME) istese RTE verir cünkü kodda TIME yok
//****LocalDateTime verip format(DateTimeFormatter.ISO_DATE) istese DATE yi verir
