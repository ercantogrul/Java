package z_calismalar.OCI_sinav._223.Q112;
public class App {
    static int count; //normalde static yok burda
    public  static  void displayMsg(){  // static bir method da sadece static variable ve methodlar kullanilir. veya bir obje ile kullanilabilir
        count++;                                         //line1
