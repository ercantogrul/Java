package z_calismalar.OCI_sinav._223.Q094_constr;
...
class Person {
    ...
    public Person(String name, int age) {    // line n2
     //   Person(name); //bir class kendi adiyla bir method olusturabilir
                        //burada bir constroctor cagrilmis,  constuctor  this(name); seklinde olmaliydi
        setAge(age);
    }
// getter and setter
