...
public class B01_sifre_kontrolu {
    public static void main(String[] args) {
        ...
        /*
            Bu soruyu day17'de cozduk ama java'da daha profesyonel kodlama icin
            iki duzeltme yapacagiz
            1-
            while loop'un onundeki parantezin ici true oldugu muddetce loop calisir

            bu soruda sonuc variable'i da boolean deger iceriyorama sorunun mantigi acisinda
            sonuc false oldugu muddetce loop calismali
            2-
            while loop her calistiginda Scanner scanner = new Scanner(System.in);
            String sifre = scanner.nextLine(); calisiyor ve yeni bir obje olusturuyor
