...
public class C02_ForlopDikkatEdilecekler {
    public static void main(String[] args) {
        ...
        // baslangic degeri ve degisim sekli, hic bir zaman bitis degerine ulasmazsa sonsuz loop olusur
        /*
        for (int i = 0; i >=0 ; i++) {
        ...
        /*
            ...
            ve loop'un geri kalanina ihtiyacimiz olmazsa orada break kullanabiliriz
