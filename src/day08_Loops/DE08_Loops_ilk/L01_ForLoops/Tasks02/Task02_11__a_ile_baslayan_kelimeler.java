...
public class Task02_11__a_ile_baslayan_kelimeler {
    public static void main(String[] args) {
        // Bir text veriliyor, tekstin içerisindeki kelimelerden , kaç tanesi 'a' veya 'A' ile başlıyordur.
        ...
        //3.yol=========================================================
        aIleBaslayanSayisi=0;
        for (int i = 0; i <str.trim().length() ; i++) {   // bosluklar alindigi icin lengt-1 demeye gerek yok
