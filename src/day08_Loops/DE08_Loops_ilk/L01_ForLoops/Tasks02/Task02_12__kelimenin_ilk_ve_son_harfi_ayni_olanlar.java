...
public class Task02_12__kelimenin_ilk_ve_son_harfi_ayni_olanlar {
    public static void main(String[] args) {
        ...
        String yStr=str.trim().replace(",","")+" ";  //ön ve arkada ki bosluklari ve virgülü sildik
        int counter = 0;
        ...
        //==============================
        System.out.println("=============ikinci yontem string ile============");
        for (int i = 0; i < yStr.length(); i++) {
            String harf = yStr.substring(i,i+1);
            if(harf.equals(" ")){
                String kelime = yStr.substring(0,i);
                yStr =yStr.substring(i+1);
                i=0;
                if (kelime.substring(0,1).equalsIgnoreCase(kelime.substring(kelime.length()-1))) counter++;
