package day27_Abstraction.DE27_Abstraction;
...
public class C01_AbstactClass {
    ...
    3- abstract method tanımlamak  için
      ...
      abstrack class tanımlamak için class ifadesinden önce abstract keyword kullanılmalı. örn:public abstract class Honda ();
